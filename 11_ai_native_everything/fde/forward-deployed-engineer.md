...
**as-of 2026-09-15** ｜ 主要依据三份材料：腾讯研究院《前线共创 双向赋能：FDE模式行业观察与实践》（2026 年 7 月，公开商业版 v5.0，83 页）、范冰（XDash）开源全文的《前线部署工程师（FDE）：人工智能时代的客户价值交付秘籍》（仓库 v1.0.24），以及北美 AI Agent 公司 Cresta 的 FDE 负责人 Jove Zhong 的一线实录（2025 年 9 月）。文中数字均可在文末的参考资料中回溯。
...
**它是岗位与流程视角**，回答的是"FDE 是什么、怎么做、谁在做"。书从开源项目转化而来，仓库 `xdash/FDE-the-Guidance-Book-of-Forward-Deployed-Engineer` 是全文公开的 Markdown（v1.0.24），付费的电子书与纸书在此基础上做了逐段润色、细节查证、排版优化、图表绘制，并对第 8 章案例集做了较大篇幅的修改。

几个我认为最有价值的部分：

- **第 1 章的"它不是什么"**：把 FDE 和售前、驻场外包、咨询顾问、产品工程师逐一切开。这四刀比正面定义更能建立准确认知，尤其"驻场外包"那一刀对国内读者是必需的
- **第 8 章的完整案例集**：Palantir、OpenAI、Anthropic、Harvey、Sierra、Databricks/Snowflake 几种变体，加上国内大厂与创业公司的实践，以及一份国内 AI 创业团队 180 天实战复盘
- **附录 A 的指标体系**：分交付层、客户层、商业层、组织层四组，是把"FDE 干得好不好"变成可测问题的少数尝试

书里也有应该被检验的引用。MIT 那份 95% 的报告，作者主动列出了三条质疑口径和一层利益关系，并说明"取的是方向，不是精确值"。这种处理方式值得学，也提醒读者对任何高传播率的单一数字保持同样的警觉。
...
需要留意的是它是一篇**个人博客长度的实录**，不是研究报告。里面的判断带强烈的个人立场（他本人就在 Cresta 招人），引用时要当从业者观点看，不是行业统计。

### 一个仍待观察的地方

腾讯研究院报告提到 OpenAI 与 Anthropic 在同一天各自宣布成立部署公司。这条在报告自己的参考文献里有出入：Anthropic 与 Blackstone、Hellman & Friedman、Goldman Sachs 的合资公司声明日期是 5 月 4 日，OpenAI 成立 Deployment Company 的博客是 5 月 11 日。两件事相隔一周，方向一致但并非同日。引用时按各自的原始日期更好。
...
| 2   | 范冰《前线部署工程师（FDE）：人工智能时代的客户价值交付秘籍》            | 开源全文仓库 `xdash/FDE-the-Guidance-Book-of-Forward-Deployed-Engineer`，v1.0.24；官网 [fde4.ai](https://fde4.ai)。本文 §二、§四、§七的主要依据                                                               |
