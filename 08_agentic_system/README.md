...
读者可以按模块深入——想先把理论脉络理清就从「核心理论与框架」开始；想直接看能跑的系统就跳到「实战项目与代码」；关心工程化边界则优先阅读 Agent Infra 与记忆/上下文两章。**零基础想从外部课程学起，先看 [Agent 学习课程 Hub](./agent_course_hub/README.md) 的小白学习路线图。**
...
- **[Agent 学习课程 Hub](./agent_course_hub/README.md)** - 按「知名度 × star 数 × 开源」筛选的外部课程与项目导航（star 数 2026-08-24 实时核实）
  - [小白学习路线图](./agent_course_hub/learning-roadmap.md) - 七个阶段从零到构建者，每阶段附参考课程、项目与本仓库关联文章
  - [课程与项目清单](./agent_course_hub/agent-course-hub.md) - 系统课程 4 门、开源框架 8 个、Harness/编码 Agent 5 个、案例库与生态协议 6 个
