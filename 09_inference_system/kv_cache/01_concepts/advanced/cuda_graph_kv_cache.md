...
- [投机解码如何与 KV Cache 交互](spec_decode_kv_cache.md) — `num_spec_tokens` 改变 query_len 导致 re-capture
- [KV Cache Prefetching](kv_cache_prefetching.md) — `requires_piecewise_for_cudagraph` 与异步 KV 加载的交互
